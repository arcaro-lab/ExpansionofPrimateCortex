...
# Extract region ROIS
nii_dir = os.path.join(os.path.dirname(__file__), './neurosynth_rois')
combined_rois = combine_rois(nii_dir)

# Fetch Neurosynth data
# Neurosynth’s data files are stored at https://github.com/neurosynth/neurosynth-data. I used version 7 data.
...
# Adjust layout and display the table plot
plt.tight_layout()
plt.show()
...
# Adjust layout and display the word cloud plot
plt.tight_layout()
plt.show()
